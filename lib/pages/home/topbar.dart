      ...
      builder: (context,sizingInformation) {
        return Container(
                  ...
                  margin: EdgeInsets.symmetric(
                    horizontal: sizingInformation.deviceScreenType == DeviceScreenType.desktop? MediaQuery.of(context).size.width * 0.1 : MediaQuery.of(context).size.width * 0.05,
                    vertical: 20,
                  ),
                  color: Colors.white,
                  child: Row(
                    mainAxisAlignment: sizingInformation.deviceScreenType == DeviceScreenType.desktop ? MainAxisAlignment.start : MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    
                    children: sizingInformation.deviceScreenType == DeviceScreenType.desktop ? [
                      SvgPicture.network(
